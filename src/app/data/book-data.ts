...
export const QUIZZES: Quiz[] = [
  {
    id: 'ch1-quiz', chapterId: 1, title: 'What is Psychology? \u2014 Quiz', titleKa: 'ფსიქოლოგია რა არის? \u2014 ვიქტორინა',
    questions: [
      { id: 'q1-1', question: 'Who established the first psychology laboratory in 1879?', questionKa: 'ვინ დააარსა პირველი ფსიქოლოგიის ლაბორატორია 1879 წელს?', options: ['Sigmund Freud', 'Wilhelm Wundt', 'William James', 'John Watson'], optionsKa: ['ზიგმუნდ ფროიდი', 'ვილჰელმ ვუნდტი', 'უილიამ ჯეიმსი', 'ჯონ უოტსონი'], correctIndex: 1, explanation: 'Wilhelm Wundt founded the first psychology lab at the University of Leipzig in 1879.', explanationKa: 'ვილჰელმ ვუნდტმა დააარსა პირველი ფსიქოლოგიის ლაბორატორია ლაიფციგის უნივერსიტეტში 1879 წელს.' },
      { id: 'q1-2', question: 'Psychology is best defined as the scientific study of:', questionKa: 'ფსიქოლოგია საუკეთესოდ განიმარტება, როგორც სამეცნიერო შესწავლა:', options: ['The mind only', 'Behavior and mental processes', 'Emotions', 'Brain chemistry'], optionsKa: ['მხოლოდ გონების', 'ქცევისა და ფსიქიკური პროცესების', 'ემოციების', 'ტვინის ქიმიის'], correctIndex: 1, explanation: 'Psychology is the scientific study of both behavior and mental processes.', explanationKa: 'ფსიქოლოგია არის ქცევისა და ფსიქიკური პროცესების სამეცნიერო შესწავლა.' },
      { id: 'q1-3', question: 'Which perspective emphasizes observable behavior?', questionKa: 'რომელი მიმართულება ხაზს უსვამს დაკვირვებად ქცევას?', options: ['Psychoanalytic', 'Humanistic', 'Behavioral', 'Cognitive'], optionsKa: ['ფსიქოანალიტიკური', 'ჰუმანისტური', 'ბიჰევიორისტული', 'კოგნიტური'], correctIndex: 2, explanation: 'Behaviorism focuses on observable, measurable behaviors.', explanationKa: 'ბიჰევიორიზმი ფოკუსირდება დაკვირვებად, გაზომვად ქცევებზე.' },
      { id: 'q1-4', question: 'The psychoanalytic approach was developed by:', questionKa: 'ფსიქოანალიტიკური მიდგომა შეიმუშავა:', options: ['Carl Rogers', 'Sigmund Freud', 'Abraham Maslow', 'Ivan Pavlov'], optionsKa: ['კარლ როჯერსმა', 'ზიგმუნდ ფროიდმა', 'აბრაჰამ მასლოუმ', 'ივან პავლოვმა'], correctIndex: 1, explanation: 'Sigmund Freud developed psychoanalysis.', explanationKa: 'ზიგმუნდ ფროიდმა შეიმუშავა ფსიქოანალიზი.' },
      { id: 'q1-5', question: 'Which school used introspection as its primary method?', questionKa: 'რომელი სკოლა იყენებდა ინტროსპექციას, როგორც ძირითად მეთოდს?', options: ['Functionalism', 'Structuralism', 'Gestalt', 'Behaviorism'], optionsKa: ['ფუნქციონალიზმი', 'სტრუქტურალიზმი', 'გეშტალტი', 'ბიჰევიორიზმი'], correctIndex: 1, explanation: 'Structuralism used introspection to analyze conscious experience.', explanationKa: 'სტრუქტურალიზმი იყენებდა ინტროსპექციას ცნობიერი გამოცდილების ანალიზისთვის.' },
      { id: 'q1-6', question: 'The humanistic perspective emphasizes:', questionKa: 'ჰუმანისტური მიმართულება ხაზს უსვამს:', options: ['Unconscious desires', 'Free will and self-actualization', 'Stimulus-response', 'Brain chemistry'], optionsKa: ['არაცნობიერ სურვილებს', 'თავისუფალ ნებას და თვითრეალიზაციას', 'სტიმულ-რეაქციას', 'ტვინის ქიმიას'], correctIndex: 1, explanation: 'Humanistic psychology focuses on personal growth and free will.', explanationKa: 'ჰუმანისტური ფსიქოლოგია ფოკუსირდება პიროვნულ ზრდასა და თავისუფალ ნებაზე.' },
      { id: 'q1-7', question: 'William James is associated with:', questionKa: 'უილიამ ჯეიმსი ასოცირდება:', options: ['Structuralism', 'Functionalism', 'Behaviorism', 'Gestalt'], optionsKa: ['სტრუქტურალიზმთან', 'ფუნქციონალიზმთან', 'ბიჰევიორიზმთან', 'გეშტალტთან'], correctIndex: 1, explanation: 'William James founded functionalism.', explanationKa: 'უილიამ ჯეიმსმა დააარსა ფუნქციონალიზმი.' },
      { id: 'q1-8', question: 'The cognitive perspective focuses on:', questionKa: 'კოგნიტური მიმართულება ფოკუსირდება:', options: ['Brain structures', 'Mental processes like thinking and memory', 'Social influences', 'Childhood experiences'], optionsKa: ['ტვინის სტრუქტურებზე', 'ფსიქიკურ პროცესებზე, როგორიცაა აზროვნება და მეხსიერება', 'სოციალურ გავლენებზე', 'ბავშვობის გამოცდილებებზე'], correctIndex: 1, explanation: 'Cognitive psychology studies internal mental processes.', explanationKa: 'კოგნიტური ფსიქოლოგია შეისწავლის შინაგან ფსიქიკურ პროცესებს.' },
      { id: 'q1-9', question: 'The biopsychosocial model includes:', questionKa: 'ბიოფსიქოსოციალური მოდელი მოიცავს:', options: ['Biology only', 'Psychology only', 'Social factors only', 'Biological, psychological, and social factors'], optionsKa: ['მხოლოდ ბიოლოგიას', 'მხოლოდ ფსიქოლოგიას', 'მხოლოდ სოციალურ ფაქტორებს', 'ბიოლოგიურ, ფსიქოლოგიურ და სოციალურ ფაქტორებს'], correctIndex: 3, explanation: 'It integrates all three factors.', explanationKa: 'ის აერთიანებს სამივე ფაქტორს.' },
      { id: 'q1-10', question: 'Which is NOT a goal of psychology?', questionKa: 'რომელი არ არის ფსიქოლოგიის მიზანი?', options: ['Describe behavior', 'Explain behavior', 'Control the economy', 'Predict behavior'], optionsKa: ['ქცევის აღწერა', 'ქცევის ახსნა', 'ეკონომიკის მართვა', 'ქცევის პროგნოზირება'], correctIndex: 2, explanation: 'The four goals are to describe, explain, predict, and influence behavior.', explanationKa: 'ოთხი მიზანია: აღწერა, ახსნა, პროგნოზირება და ქცევაზე ზემოქმედება.' }
    ]
  },
  {
    id: 'ch2-quiz', chapterId: 2, title: 'Research Methods \u2014 Quiz', titleKa: 'კვლევის მეთოდები \u2014 ვიქტორინა',
    questions: [
      { id: 'q2-1', question: 'The variable manipulated by the researcher is the:', questionKa: 'მკვლევარის მიერ მანიპულირებული ცვლადი არის:', options: ['Dependent variable', 'Independent variable', 'Control variable', 'Confounding variable'], optionsKa: ['დამოკიდებული ცვლადი', 'დამოუკიდებელი ცვლადი', 'საკონტროლო ცვლადი', 'შერეული ცვლადი'], correctIndex: 1, explanation: 'The independent variable is what the researcher manipulates.', explanationKa: 'დამოუკიდებელი ცვლადი არის ის, რასაც მკვლევარი მანიპულირებს.' },
      { id: 'q2-2', question: 'A positive correlation means:', questionKa: 'დადებითი კორელაცია ნიშნავს:', options: ['One causes the other', 'As one increases the other decreases', 'Both increase together', 'No relationship'], optionsKa: ['ერთი იწვევს მეორეს', 'ერთის ზრდისას მეორე მცირდება', 'ორივე ერთად იზრდება', 'კავშირი არ არის'], correctIndex: 2, explanation: 'Both variables move in the same direction.', explanationKa: 'ორივე ცვლადი ერთი მიმართულებით მოძრაობს.' },
      { id: 'q2-3', question: 'The placebo effect demonstrates:', questionKa: 'პლაცებოს ეფექტი აჩვენებს:', options: ['Power of belief on outcomes', 'Experiments fail', 'Drugs never work', 'Correlation equals causation'], optionsKa: ['რწმენის ძალას შედეგებზე', 'ექსპერიმენტები ვერ ხერხდება', 'წამლები არასოდეს მუშაობს', 'კორელაცია ტოლია მიზეზობრიობის'], correctIndex: 0, explanation: 'Improvement from belief in treatment.', explanationKa: 'გაუმჯობესება მკურნალობის რწმენიდან.' },
      { id: 'q2-4', question: 'Which method establishes cause and effect?', questionKa: 'რომელი მეთოდი ადგენს მიზეზ-შედეგობრივ კავშირს?', options: ['Survey', 'Case study', 'Experiment', 'Observation'], optionsKa: ['გამოკითხვა', 'შემთხვევის შესწავლა', 'ექსპერიმენტი', 'დაკვირვება'], correctIndex: 2, explanation: 'Only experiments can establish cause-and-effect.', explanationKa: 'მხოლოდ ექსპერიმენტს შეუძლია მიზეზ-შედეგობრიობის დადგენა.' },
      { id: 'q2-5', question: 'Random assignment helps to:', questionKa: 'შემთხვევითი განაწილება ეხმარება:', options: ['Increase sample', 'Equalize groups', 'Make results public', 'Speed research'], optionsKa: ['ნიმუშის გაზრდას', 'ჯგუფების გათანაბრებას', 'შედეგების გასაჯაროებას', 'კვლევის დაჩქარებას'], correctIndex: 1, explanation: 'Random assignment ensures groups are equivalent.', explanationKa: 'შემთხვევითი განაწილება უზრუნველყოფს ჯგუფების ეკვივალენტურობას.' },
      { id: 'q2-6', question: 'A double-blind study means:', questionKa: 'ორმაგი ბრმა კვლევა ნიშნავს:', options: ['No one knows hypothesis', 'Neither side knows assignments', 'Two experiments run', 'Both eyes covered'], optionsKa: ['არავინ იცის ჰიპოთეზა', 'არც ერთი მხარე არ იცის განაწილება', 'ორი ექსპერიმენტი მიმდინარეობს', 'ორივე თვალი დახურულია'], correctIndex: 1, explanation: 'Neither participants nor researchers know group assignments.', explanationKa: 'არც მონაწილეებმა და არც მკვლევარებმა არ იციან ჯგუფთა განაწილება.' },
      { id: 'q2-7', question: 'Correlation does not equal causation means:', questionKa: 'კორელაცია არ ნიშნავს მიზეზობრიობას, ეს ნიშნავს:', options: ['Correlations are useless', 'Being related does not mean causation', 'All research is flawed', 'Experiments unnecessary'], optionsKa: ['კორელაციები უსარგებლოა', 'კავშირი არ ნიშნავს მიზეზობრიობას', 'ყველა კვლევა ხარვეზიანია', 'ექსპერიმენტები არ არის საჭირო'], correctIndex: 1, explanation: 'Correlation does not prove direct causation.', explanationKa: 'კორელაცია არ ამტკიცებს პირდაპირ მიზეზობრიობას.' },
      { id: 'q2-8', question: 'Informed consent means participants:', questionKa: 'ინფორმირებული თანხმობა ნიშნავს, რომ მონაწილეები:', options: ['Are paid well', 'Understand and agree voluntarily', 'Must finish the study', 'Are students'], optionsKa: ['კარგად არიან ანაზღაურებული', 'ესმით და ნებაყოფლობით თანხმდებიან', 'კვლევას ბოლომდე უნდა დაასრულონ', 'სტუდენტები არიან'], correctIndex: 1, explanation: 'Participants must understand and agree voluntarily.', explanationKa: 'მონაწილეებს უნდა ესმოდეთ და ნებაყოფლობით დათანხმდნენ.' },
      { id: 'q2-9', question: 'Which provides most in-depth info about one individual?', questionKa: 'რომელი იძლევა ყველაზე სიღრმისეულ ინფორმაციას ერთი ინდივიდის შესახებ?', options: ['Survey', 'Experiment', 'Case study', 'Correlation study'], optionsKa: ['გამოკითხვა', 'ექსპერიმენტი', 'შემთხვევის შესწავლა', 'კორელაციური კვლევა'], correctIndex: 2, explanation: 'Case studies are deeply detailed.', explanationKa: 'შემთხვევის შესწავლა ღრმად დეტალურია.' },
      { id: 'q2-10', question: 'The mean is:', questionKa: 'საშუალო არითმეტიკული არის:', options: ['Most frequent score', 'Middle score', 'Arithmetic average', 'Range of scores'], optionsKa: ['ყველაზე ხშირი ქულა', 'შუალედური ქულა', 'არითმეტიკული საშუალო', 'ქულების დიაპაზონი'], correctIndex: 2, explanation: 'The mean is the arithmetic average.', explanationKa: 'საშუალო არითმეტიკული არის არითმეტიკული საშუალო.' }
    ]
  },
  {
    id: 'ch3-quiz', chapterId: 3, title: 'Biological Bases \u2014 Quiz', titleKa: 'ბიოლოგიური საფუძვლები \u2014 ვიქტორინა',
    questions: [
      { id: 'q3-1', question: 'The gap between two neurons is the:', questionKa: 'ორ ნეირონს შორის უფსკრული არის:', options: ['Axon terminal', 'Synapse', 'Dendrite', 'Myelin sheath'], optionsKa: ['აქსონის ტერმინალი', 'სინაფსი', 'დენდრიტი', 'მიელინის გარსი'], correctIndex: 1, explanation: 'The synapse is the gap between neurons.', explanationKa: 'სინაფსი არის უფსკრული ნეირონებს შორის.' },
      { id: 'q3-2', question: 'Which neurotransmitter is linked to pleasure and reward?', questionKa: 'რომელი ნეიროტრანსმიტერი არის დაკავშირებული სიამოვნებასთან და ჯილდოსთან?', options: ['Serotonin', 'GABA', 'Dopamine', 'Acetylcholine'], optionsKa: ['სეროტონინი', 'GABA', 'დოფამინი', 'აცეტილქოლინი'], correctIndex: 2, explanation: 'Dopamine plays a key role in reward.', explanationKa: 'დოფამინი მნიშვნელოვან როლს თამაშობს ჯილდოს სისტემაში.' },
      { id: 'q3-3', question: 'The cerebral cortex has how many lobes?', questionKa: 'თავის ტვინის ქერქს რამდენი წილი აქვს?', options: ['Two', 'Three', 'Four', 'Five'], optionsKa: ['ორი', 'სამი', 'ოთხი', 'ხუთი'], correctIndex: 2, explanation: 'Four lobes: frontal, parietal, temporal, occipital.', explanationKa: 'ოთხი წილი: შუბლის, თხემის, საფეთქლის, კეფის.' },
      { id: 'q3-4', question: 'Broca\'s area controls:', questionKa: 'ბროკას არე აკონტროლებს:', options: ['Vision', 'Speech production', 'Hearing', 'Movement'], optionsKa: ['მხედველობას', 'მეტყველების წარმოებას', 'სმენას', 'მოძრაობას'], correctIndex: 1, explanation: 'Broca\'s area controls speech production.', explanationKa: 'ბროკას არე აკონტროლებს მეტყველების წარმოებას.' },
      { id: 'q3-5', question: 'Fight-or-flight is activated by:', questionKa: 'ბრძოლა-ან-გაქცევა აქტივირდება:', options: ['Parasympathetic NS', 'Sympathetic NS', 'Somatic NS', 'Central NS'], optionsKa: ['პარასიმპათიკური ნერვული სისტემით', 'სიმპათიკური ნერვული სისტემით', 'სომატური ნერვული სისტემით', 'ცენტრალური ნერვული სისტემით'], correctIndex: 1, explanation: 'The sympathetic nervous system activates fight-or-flight.', explanationKa: 'სიმპათიკური ნერვული სისტემა აქტივირებს ბრძოლა-ან-გაქცევის რეაქციას.' },
      { id: 'q3-6', question: 'Myelin sheath serves to:', questionKa: 'მიელინის გარსის ფუნქციაა:', options: ['Generate neurotransmitters', 'Speed up transmission', 'Store memories', 'Connect hemispheres'], optionsKa: ['ნეიროტრანსმიტერების წარმოება', 'გადაცემის დაჩქარება', 'მოგონებების შენახვა', 'ნახევარსფეროების დაკავშირება'], correctIndex: 1, explanation: 'Myelin insulates axons for faster signals.', explanationKa: 'მიელინი იზოლირებს აქსონებს სიგნალების უფრო სწრაფი გადაცემისთვის.' },
      { id: 'q3-7', question: 'Hippocampus is associated with:', questionKa: 'ჰიპოკამპი ასოცირდება:', options: ['Emotion regulation', 'Memory formation', 'Visual processing', 'Motor control'], optionsKa: ['ემოციების რეგულაციასთან', 'მეხსიერების ფორმირებასთან', 'ვიზუალურ დამუშავებასთან', 'მოტორულ კონტროლთან'], correctIndex: 1, explanation: 'The hippocampus is essential for forming memories.', explanationKa: 'ჰიპოკამპი აუცილებელია მოგონებების ფორმირებისთვის.' },
      { id: 'q3-8', question: 'Which connects the two hemispheres?', questionKa: 'რომელი აკავშირებს ორ ნახევარსფეროს?', options: ['Cerebellum', 'Corpus callosum', 'Thalamus', 'Hypothalamus'], optionsKa: ['ნათხემი', 'თხელი სხეული', 'თალამუსი', 'ჰიპოთალამუსი'], correctIndex: 1, explanation: 'The corpus callosum connects the hemispheres.', explanationKa: 'თხელი სხეული აკავშირებს ნახევარსფეროებს.' },
      { id: 'q3-9', question: 'Endorphins are chemicals that:', questionKa: 'ენდორფინები არის ქიმიური ნივთიერებები, რომლებიც:', options: ['Increase pain', 'Reduce pain and produce pleasure', 'Cause depression', 'Slow neurons'], optionsKa: ['ზრდიან ტკივილს', 'ამცირებენ ტკივილს და იწვევენ სიამოვნებას', 'იწვევენ დეპრესიას', 'ანელებენ ნეირონებს'], correctIndex: 1, explanation: 'Endorphins are natural painkillers.', explanationKa: 'ენდორფინები ბუნებრივი ტკივილგამაყუჩებლებია.' },
      { id: 'q3-10', question: 'Neuroplasticity is the brain\'s ability to:', questionKa: 'ნეიროპლასტიკურობა არის ტვინის უნარი:', options: ['Remain unchanged', 'Form new connections', 'Only work in childhood', 'Produce hormones'], optionsKa: ['უცვლელი დარჩეს', 'ახალი კავშირების ჩამოყალიბება', 'მხოლოდ ბავშვობაში მუშაობა', 'ჰორმონების წარმოება'], correctIndex: 1, explanation: 'The brain can form new neural connections throughout life.', explanationKa: 'ტვინს შეუძლია ახალი ნეირონული კავშირების ჩამოყალიბება მთელი ცხოვრების მანძილზე.' }
    ]
  },
  {
    id: 'ch4-quiz', chapterId: 4, title: 'Sensation and Perception \u2014 Quiz', titleKa: 'შეგრძნება და აღქმა \u2014 ვიქტორინა',
    questions: [
      { id: 'q4-1', question: 'Minimum stimulation detected 50% of the time:', questionKa: 'მინიმალური სტიმულაცია, რომელიც აღმოჩენილია დროის 50%-ში:', options: ['Difference threshold', 'Absolute threshold', 'Signal detection', 'Weber\'s law'], optionsKa: ['განსხვავების ზღვარი', 'აბსოლუტური ზღვარი', 'სიგნალის აღმოჩენა', 'ვებერის კანონი'], correctIndex: 1, explanation: 'Absolute threshold: minimum detected 50% of the time.', explanationKa: 'აბსოლუტური ზღვარი: მინიმალური სტიმულაცია, აღმოჩენილი დროის 50%-ში.' },
      { id: 'q4-2', question: 'Which Gestalt principle groups nearby objects?', questionKa: 'გეშტალტის რომელი პრინციპი აჯგუფებს ახლომდებარე ობიექტებს?', options: ['Similarity', 'Proximity', 'Closure', 'Continuity'], optionsKa: ['მსგავსება', 'სიახლოვე', 'დახურულობა', 'უწყვეტობა'], correctIndex: 1, explanation: 'Proximity: nearby objects are grouped.', explanationKa: 'სიახლოვე: ახლომდებარე ობიექტები ჯგუფდება.' },
      { id: 'q4-3', question: 'Rods in the retina are for:', questionKa: 'ბადურის ჩხირები განკუთვნილია:', options: ['Color vision', 'Dim light vision', 'Detail focus', 'Depth perception'], optionsKa: ['ფერთა მხედველობისთვის', 'სუსტ შუქში ხედვისთვის', 'დეტალების ფოკუსირებისთვის', 'სიღრმის აღქმისთვის'], correctIndex: 1, explanation: 'Rods function in dim light.', explanationKa: 'ჩხირები ფუნქციონირებენ სუსტ შუქში.' },
      { id: 'q4-4', question: 'Converting stimuli to neural signals is:', questionKa: 'სტიმულების ნერვულ სიგნალებად გარდაქმნა არის:', options: ['Perception', 'Transduction', 'Accommodation', 'Adaptation'], optionsKa: ['აღქმა', 'ტრანსდუქცია', 'აკომოდაცია', 'ადაპტაცია'], correctIndex: 1, explanation: 'Transduction converts physical energy to signals.', explanationKa: 'ტრანსდუქცია გარდაქმნის ფიზიკურ ენერგიას სიგნალებად.' },
      { id: 'q4-5', question: 'Sound frequency determines:', questionKa: 'ხმის სიხშირე განსაზღვრავს:', options: ['Loudness', 'Pitch', 'Timbre', 'Duration'], optionsKa: ['ხმამაღლობას', 'ტონალობას', 'ტემბრს', 'ხანგრძლივობას'], correctIndex: 1, explanation: 'Frequency determines pitch.', explanationKa: 'სიხშირე განსაზღვრავს ტონალობას.' },
      { id: 'q4-6', question: 'The blind spot exists because:', questionKa: 'ბრმა ლაქა არსებობს, რადგან:', options: ['No cones there', 'No receptors where optic nerve exits', 'Imperfect lens', 'Light damage'], optionsKa: ['იქ კონუსები არ არის', 'არ არის რეცეპტორები მხედველობის ნერვის გამოსვლის ადგილას', 'არასრულყოფილი ლინზა', 'სინათლის დაზიანება'], correctIndex: 1, explanation: 'No receptors where the optic nerve exits.', explanationKa: 'არ არის რეცეპტორები იქ, სადაც მხედველობის ნერვი გამოდის.' },
      { id: 'q4-7', question: 'Top-down processing is guided by:', questionKa: 'ზემოდან-ქვემოთ დამუშავება ხელმძღვანელობს:', options: ['Raw sensory data', 'Expectations and prior knowledge', 'Stimulus intensity', 'Receptor cells'], optionsKa: ['ნედლი სენსორული მონაცემებით', 'მოლოდინებითა და წინარე ცოდნით', 'სტიმულის ინტენსივობით', 'რეცეპტორული უჯრედებით'], correctIndex: 1, explanation: 'Experience and knowledge guide top-down processing.', explanationKa: 'გამოცდილება და ცოდნა ხელმძღვანელობს ზემოდან-ქვემოთ დამუშავებას.' },
      { id: 'q4-8', question: 'Sensory adaptation is:', questionKa: 'სენსორული ადაპტაცია არის:', options: ['Learning new skills', 'Decreased sensitivity to constant stimulus', 'Increased pain', 'Improved vision'], optionsKa: ['ახალი უნარების შესწავლა', 'მუდმივ სტიმულზე მგრძნობელობის დაქვეითება', 'ტკივილის გაძლიერება', 'მხედველობის გაუმჯობესება'], correctIndex: 1, explanation: 'Reduced sensitivity to unchanging stimuli.', explanationKa: 'შემცირებული მგრძნობელობა უცვლელ სტიმულებზე.' },
      { id: 'q4-9', question: 'Binocular depth cues require:', questionKa: 'ბინოკულარული სიღრმის მინიშნებები მოითხოვს:', options: ['One eye', 'Both eyes', 'Hearing', 'Touch'], optionsKa: ['ერთ თვალს', 'ორივე თვალს', 'სმენას', 'შეხებას'], correctIndex: 1, explanation: 'Both eyes needed for binocular depth cues.', explanationKa: 'ბინოკულარული სიღრმის მინიშნებებისთვის ორივე თვალია საჭირო.' },
      { id: 'q4-10', question: 'Opponent-process theory explains:', questionKa: 'ოპონენტ-პროცესის თეორია ხსნის:', options: ['3D vision', 'Color via opposing pairs', 'Smell adaptation', 'Pain'], optionsKa: ['3D მხედველობას', 'ფერს საპირისპირო წყვილების მეშვეობით', 'სუნის ადაპტაციას', 'ტკივილს'], correctIndex: 1, explanation: 'Color perception through three opposing pairs.', explanationKa: 'ფერის აღქმა სამი საპირისპირო წყვილის მეშვეობით.' }
    ]
  },
  {
    id: 'ch5-quiz', chapterId: 5, title: 'Consciousness \u2014 Quiz', titleKa: 'ცნობიერება \u2014 ვიქტორინა',
    questions: [
      { id: 'q5-1', question: 'REM sleep features:', questionKa: 'REM ძილის მახასიათებლებია:', options: ['Deep relaxation', 'Rapid eye movements and vivid dreams', 'No brain activity', 'Sleepwalking'], optionsKa: ['ღრმა მოდუნება', 'სწრაფი თვალის მოძრაობები და ნათელი სიზმრები', 'ტვინის აქტივობა არ არის', 'ძილში სიარული'], correctIndex: 1, explanation: 'REM: rapid eye movements and vivid dreaming.', explanationKa: 'REM: სწრაფი თვალის მოძრაობები და ნათელი სიზმრები.' },
      { id: 'q5-2', question: 'Freud said dreams represent:', questionKa: 'ფროიდის მიხედვით სიზმრები წარმოადგენს:', options: ['Random neural firing', 'Wish fulfillment', 'Memory consolidation', 'Nothing meaningful'], optionsKa: ['ნეირონების შემთხვევით აქტივაციას', 'სურვილის შესრულებას', 'მეხსიერების კონსოლიდაციას', 'არაფერ მნიშვნელოვანს'], correctIndex: 1, explanation: 'Freud: dreams are disguised wish fulfillment.', explanationKa: 'ფროიდი: სიზმრები არის შენიღბული სურვილების შესრულება.' },
      { id: 'q5-3', question: 'Circadian rhythm is approximately:', questionKa: 'ცირკადული რიტმი დაახლოებით არის:', options: ['12 hours', '24 hours', '48 hours', '8 hours'], optionsKa: ['12 საათი', '24 საათი', '48 საათი', '8 საათი'], correctIndex: 1, explanation: 'Roughly 24-hour cycle.', explanationKa: 'დაახლოებით 24-საათიანი ციკლი.' },
      { id: 'q5-4', question: 'Sleep deprivation impairs:', questionKa: 'ძილის დეფიციტი აუარესებს:', options: ['Physical strength', 'Concentration and decisions', 'Height', 'Hearing'], optionsKa: ['ფიზიკურ ძალას', 'კონცენტრაციასა და გადაწყვეტილებებს', 'სიმაღლეს', 'სმენას'], correctIndex: 1, explanation: 'Sleep loss impairs cognitive function.', explanationKa: 'ძილის დეფიციტი აუარესებს კოგნიტურ ფუნქციას.' },
      { id: 'q5-5', question: 'Activation-synthesis says dreams are:', questionKa: 'აქტივაცია-სინთეზის თეორიის მიხედვით სიზმრები არის:', options: ['Unconscious wishes', 'Brain interpreting random neural activity', 'Supernatural', 'Repressed memories'], optionsKa: ['არაცნობიერი სურვილები', 'ტვინი ინტერპრეტაციას უკეთებს შემთხვევით ნეირონულ აქტივობას', 'ზებუნებრივი', 'ჩახშობილი მოგონებები'], correctIndex: 1, explanation: 'Brain makes sense of random neural signals.', explanationKa: 'ტვინი აზრს ანიჭებს შემთხვევით ნეირონულ სიგნალებს.' },
      { id: 'q5-6', question: 'Narcolepsy involves:', questionKa: 'ნარკოლეფსია მოიცავს:', options: ['Inability to sleep', 'Sudden sleep attacks', 'Snoring', 'Nightmares only'], optionsKa: ['ძილის უუნარობას', 'ძილის უეცარ შეტევებს', 'ხვრინვას', 'მხოლოდ კოშმარებს'], correctIndex: 1, explanation: 'Sudden uncontrollable episodes of falling asleep.', explanationKa: 'ძილის უეცარი, უკონტროლო ეპიზოდები.' },
      { id: 'q5-7', question: 'Hypnosis is best described as:', questionKa: 'ჰიპნოზი საუკეთესოდ აღიწერება, როგორც:', options: ['Heightened suggestibility', 'Deep sleep', 'Unconsciousness', 'Anesthesia'], optionsKa: ['გაძლიერებული შთაგონებადობა', 'ღრმა ძილი', 'უგონო მდგომარეობა', 'ანესთეზია'], correctIndex: 0, explanation: 'Heightened suggestibility and focused attention.', explanationKa: 'გაძლიერებული შთაგონებადობა და ფოკუსირებული ყურადღება.' },
      { id: 'q5-8', question: 'Melatonin regulates:', questionKa: 'მელატონინი არეგულირებს:', options: ['Hunger', 'Sleep', 'Growth', 'Adrenaline'], optionsKa: ['შიმშილს', 'ძილს', 'ზრდას', 'ადრენალინს'], correctIndex: 1, explanation: 'Melatonin regulates the sleep-wake cycle.', explanationKa: 'მელატონინი არეგულირებს ძილ-ღვიძილის ციკლს.' },
      { id: 'q5-9', question: 'Tolerance means:', questionKa: 'ტოლერანტობა ნიშნავს:', options: ['You dislike it', 'Need more for same effect', 'Addicted', 'No longer exists'], optionsKa: ['არ მოგწონთ', 'მეტია საჭირო იმავე ეფექტისთვის', 'დამოკიდებული ხართ', 'აღარ არსებობს'], correctIndex: 1, explanation: 'Needing more to achieve the same effect.', explanationKa: 'მეტი საჭიროება იმავე ეფექტის მისაღწევად.' },
      { id: 'q5-10', question: 'Delta waves are associated with:', questionKa: 'დელტა ტალღები ასოცირდება:', options: ['Alertness', 'REM sleep', 'Deep non-REM sleep', 'Light sleep'], optionsKa: ['ფხიზლობასთან', 'REM ძილთან', 'ღრმა არა-REM ძილთან', 'მსუბუქ ძილთან'], correctIndex: 2, explanation: 'Delta waves characterize deep non-REM sleep.', explanationKa: 'დელტა ტალღები ახასიათებს ღრმა არა-REM ძილს.' }
    ]
  },
  {
    id: 'ch6-quiz', chapterId: 6, title: 'Learning \u2014 Quiz', titleKa: 'სწავლა \u2014 ვიქტორინა',
    questions: [
      { id: 'q6-1', question: 'In Pavlov\'s experiment, the bell started as a:', questionKa: 'პავლოვის ექსპერიმენტში ზარი თავდაპირველად იყო:', options: ['Conditioned stimulus', 'Unconditioned stimulus', 'Neutral stimulus', 'Conditioned response'], optionsKa: ['პირობითი სტიმული', 'უპირობო სტიმული', 'ნეიტრალური სტიმული', 'პირობითი რეაქცია'], correctIndex: 2, explanation: 'The bell was initially neutral.', explanationKa: 'ზარი თავდაპირველად ნეიტრალური იყო.' },
      { id: 'q6-2', question: 'Negative reinforcement involves:', questionKa: 'უარყოფითი განმტკიცება მოიცავს:', options: ['Punishment', 'Adding unpleasant stimulus', 'Removing unpleasant stimulus', 'Ignoring behavior'], optionsKa: ['დასჯას', 'უსიამოვნო სტიმულის დამატებას', 'უსიამოვნო სტიმულის მოცილებას', 'ქცევის იგნორირებას'], correctIndex: 2, explanation: 'Removing aversive stimulus strengthens behavior.', explanationKa: 'ავერსიული სტიმულის მოცილება აძლიერებს ქცევას.' },
      { id: 'q6-3', question: 'Bandura\'s Bobo doll showed:', questionKa: 'ბანდურას ბობო თოჯინის ექსპერიმენტმა აჩვენა:', options: ['Classical conditioning', 'Operant conditioning', 'Observational learning', 'Habituation'], optionsKa: ['კლასიკური განპირობება', 'ოპერანტული განპირობება', 'დაკვირვებით სწავლა', 'ჰაბიტუაცია'], correctIndex: 2, explanation: 'Children learned aggression by watching.', explanationKa: 'ბავშვებმა აგრესია ყურებით ისწავლეს.' },
      { id: 'q6-4', question: 'Extinction occurs when:', questionKa: 'ჩაქრობა ხდება, როცა:', options: ['CS presented without US repeatedly', 'Punishment applied', 'Organism dies', 'Response strengthens'], optionsKa: ['პირობითი სტიმული მრავალჯერ წარედგინება უპირობოს გარეშე', 'დასჯა გამოიყენება', 'ორგანიზმი კვდება', 'რეაქცია ძლიერდება'], correctIndex: 0, explanation: 'CS without US weakens the response.', explanationKa: 'პირობითი სტიმული უპირობოს გარეშე ასუსტებს რეაქციას.' },
      { id: 'q6-5', question: 'Variable-ratio schedule produces:', questionKa: 'ცვლადი-თანაფარდობის გრაფიკი იწვევს:', options: ['Slow responding', 'High steady responding', 'Quick extinction', 'No responding'], optionsKa: ['ნელ რეაგირებას', 'მაღალ სტაბილურ რეაგირებას', 'სწრაფ ჩაქრობას', 'რეაგირების არარსებობას'], correctIndex: 1, explanation: 'Variable-ratio produces highest response rates.', explanationKa: 'ცვლადი-თანაფარდობა იწვევს რეაგირების ყველაზე მაღალ სიხშირეს.' },
      { id: 'q6-6', question: 'Shaping involves:', questionKa: 'ფორმირება მოიცავს:', options: ['Punishing all behaviors', 'Reinforcing successive approximations', 'Ignoring organism', 'Only classical conditioning'], optionsKa: ['ყველა ქცევის დასჯას', 'თანმიმდევრული მიახლოვებების განმტკიცებას', 'ორგანიზმის იგნორირებას', 'მხოლოდ კლასიკურ განპირობებას'], correctIndex: 1, explanation: 'Reinforcing progressively closer behaviors.', explanationKa: 'თანდათანობით უფრო ახლო ქცევების განმტკიცება.' },
      { id: 'q6-7', question: 'Little Albert learned fear through:', questionKa: 'პატარა ალბერტმა შიში ისწავლა:', options: ['Operant conditioning', 'Classical conditioning', 'Maturation', 'Insight'], optionsKa: ['ოპერანტული განპირობებით', 'კლასიკური განპირობებით', 'მომწიფებით', 'ინსაიტით'], correctIndex: 1, explanation: 'Watson used classical conditioning.', explanationKa: 'უოტსონმა გამოიყენა კლასიკური განპირობება.' },
      { id: 'q6-8', question: 'Positive punishment example:', questionKa: 'დადებითი დასჯის მაგალითი:', options: ['Taking away a toy', 'Getting a speeding ticket', 'Removing a shock', 'Getting a reward'], optionsKa: ['სათამაშოს წართმევა', 'სიჩქარის ჯარიმის მიღება', 'ელექტროშოკის მოცილება', 'ჯილდოს მიღება'], correctIndex: 1, explanation: 'Adding an aversive consequence.', explanationKa: 'ავერსიული შედეგის დამატება.' },
      { id: 'q6-9', question: 'Latent learning was shown by:', questionKa: 'ლატენტური სწავლა აჩვენა:', options: ['Pavlov', 'Skinner', 'Tolman', 'Bandura'], optionsKa: ['პავლოვმა', 'სკინერმა', 'ტოლმენმა', 'ბანდურამ'], correctIndex: 2, explanation: 'Tolman showed rats formed cognitive maps.', explanationKa: 'ტოლმენმა აჩვენა, რომ ვირთხები კოგნიტურ რუკებს ქმნიდნენ.' },
      { id: 'q6-10', question: 'Stimulus generalization means:', questionKa: 'სტიმულის განზოგადება ნიშნავს:', options: ['Responding to exact stimuli only', 'Responding to similar stimuli', 'No response', 'Faster extinction'], optionsKa: ['მხოლოდ ზუსტ სტიმულებზე რეაგირებას', 'მსგავს სტიმულებზე რეაგირებას', 'რეაქციის არარსებობას', 'უფრო სწრაფ ჩაქრობას'], correctIndex: 1, explanation: 'Responding to stimuli similar to the conditioned one.', explanationKa: 'პირობითი სტიმულის მსგავს სტიმულებზე რეაგირება.' }
    ]
  },
  {
    id: 'ch7-quiz', chapterId: 7, title: 'Memory \u2014 Quiz', titleKa: 'მეხსიერება \u2014 ვიქტორინა',
    questions: [
      { id: 'q7-1', question: 'Sensory memory lasts:', questionKa: 'სენსორული მეხსიერება გრძელდება:', options: ['A few seconds', 'A fraction of a second to seconds', 'Minutes', 'Hours'], optionsKa: ['რამდენიმე წამი', 'წამის მეასედიდან წამებამდე', 'წუთები', 'საათები'], correctIndex: 1, explanation: 'Very brief duration.', explanationKa: 'ძალიან მოკლე ხანგრძლივობა.' },
      { id: 'q7-2', question: 'Short-term memory capacity:', questionKa: 'მოკლევადიანი მეხსიერების ტევადობა:', options: ['2 items', '7 +/- 2 items', '15 items', 'Unlimited'], optionsKa: ['2 ერთეული', '7 +/- 2 ერთეული', '15 ერთეული', 'შეუზღუდავი'], correctIndex: 1, explanation: 'Miller\'s magic number: 7 plus or minus 2.', explanationKa: 'მილერის ჯადოსნური რიცხვი: 7 პლუს ან მინუს 2.' },
      { id: 'q7-3', question: 'Elaborative rehearsal involves:', questionKa: 'ელაბორაციული გამეორება მოიცავს:', options: ['Simple repetition', 'Connecting to existing knowledge', 'Forgetting', 'Writing only'], optionsKa: ['მარტივ გამეორებას', 'არსებულ ცოდნასთან დაკავშირებას', 'დავიწყებას', 'მხოლოდ წერას'], correctIndex: 1, explanation: 'Connecting new info to existing memories.', explanationKa: 'ახალი ინფორმაციის არსებულ მოგონებებთან დაკავშირება.' },
      { id: 'q7-4', question: 'Ebbinghaus\' forgetting curve shows:', questionKa: 'ებინჰაუსის დავიწყების მრუდი აჩვენებს:', options: ['Linear forgetting', 'Rapid then leveling off', 'No natural forgetting', 'Steady increase'], optionsKa: ['ხაზოვან დავიწყებას', 'სწრაფს, შემდეგ სტაბილიზაციას', 'ბუნებრივი დავიწყება არ არსებობს', 'სტაბილურ ზრდას'], correctIndex: 1, explanation: 'Forgetting is rapid at first, then levels off.', explanationKa: 'დავიწყება თავდაპირველად სწრაფია, შემდეგ სტაბილიზდება.' },
      { id: 'q7-5', question: 'Retrograde amnesia is:', questionKa: 'რეტროგრადული ამნეზია არის:', options: ['Can\'t form new memories', 'Loss of past memories', 'Loss of procedural memory', 'Loss of language'], optionsKa: ['ახალი მოგონებების ჩამოყალიბების უუნარობა', 'წარსული მოგონებების დაკარგვა', 'პროცედურული მეხსიერების დაკარგვა', 'ენის დაკარგვა'], correctIndex: 1, explanation: 'Inability to recall previously stored memories.', explanationKa: 'ადრე შენახული მოგონებების გახსენების უუნარობა.' },
      { id: 'q7-6', question: 'Primacy effect is better recall of:', questionKa: 'პირველობის ეფექტი არის უკეთესი გახსენება:', options: ['End items', 'Beginning items', 'Middle items', 'Random items'], optionsKa: ['ბოლო ელემენტების', 'საწყისი ელემენტების', 'შუალედური ელემენტების', 'შემთხვევითი ელემენტების'], correctIndex: 1, explanation: 'Better recall of items at the beginning.', explanationKa: 'საწყისი ელემენტების უკეთესი გახსენება.' },
      { id: 'q7-7', question: 'Implicit memory includes:', questionKa: 'იმპლიციტური მეხსიერება მოიცავს:', options: ['Conscious recall', 'Skills and habits', 'Episodic only', 'Semantic only'], optionsKa: ['ცნობიერ გახსენებას', 'უნარებსა და ჩვევებს', 'მხოლოდ ეპიზოდურს', 'მხოლოდ სემანტიკურს'], correctIndex: 1, explanation: 'Implicit: procedural skills and habits.', explanationKa: 'იმპლიციტური: პროცედურული უნარები და ჩვევები.' },
      { id: 'q7-8', question: 'Loftus demonstrated:', questionKa: 'ლოფტუსმა აჩვენა:', options: ['Perfect recall', 'False memories can be created', 'Photographic memory', 'Memory never changes'], optionsKa: ['სრულყოფილი გახსენება', 'ყალბი მოგონებების შექმნა შესაძლებელია', 'ფოტოგრაფიული მეხსიერება', 'მეხსიერება არასოდეს იცვლება'], correctIndex: 1, explanation: 'Misleading info alters memories.', explanationKa: 'შეცდომაში შემყვანი ინფორმაცია ცვლის მოგონებებს.' },
      { id: 'q7-9', question: 'Method of loci is a:', questionKa: 'ლოკუსების მეთოდი არის:', options: ['Type of forgetting', 'Mnemonic using locations', 'Brain structure', 'Memory disorder'], optionsKa: ['დავიწყების ტიპი', 'მნემონიკური ტექნიკა ადგილების გამოყენებით', 'ტვინის სტრუქტურა', 'მეხსიერების აშლილობა'], correctIndex: 1, explanation: 'Associate items with familiar locations.', explanationKa: 'ელემენტების დაკავშირება ნაცნობ ადგილებთან.' },
      { id: 'q7-10', question: 'LTP is:', questionKa: 'გრძელვადიანი პოტენციაცია (LTP) არის:', options: ['Memory loss', 'Strengthening neural connections', 'Amnesia', 'Short-term storage'], optionsKa: ['მეხსიერების დაკარგვა', 'ნეირონული კავშირების გაძლიერება', 'ამნეზია', 'მოკლევადიანი შენახვა'], correctIndex: 1, explanation: 'Synaptic connections strengthen with repeated use.', explanationKa: 'სინაფსური კავშირები ძლიერდება განმეორებითი გამოყენებით.' }
    ]
  },
  {
    id: 'ch8-quiz', chapterId: 8, title: 'Cognition and Intelligence \u2014 Quiz', titleKa: 'შემეცნება და ინტელექტი \u2014 ვიქტორინა',
    questions: [
      { id: 'q8-1', question: 'A heuristic is:', questionKa: 'ევრისტიკა არის:', options: ['Guaranteed solution', 'Mental shortcut', 'Memory type', 'Brain structure'], optionsKa: ['გარანტირებული გადაწყვეტა', 'გონებრივი მალსახმობი', 'მეხსიერების ტიპი', 'ტვინის სტრუქტურა'], correctIndex: 1, explanation: 'Quick mental shortcuts for decisions.', explanationKa: 'სწრაფი გონებრივი მალსახმობები გადაწყვეტილებებისთვის.' },
      { id: 'q8-2', question: 'Confirmation bias is:', questionKa: 'დადასტურების მიკერძოება არის:', options: ['Seeking confirming info', 'Considering all evidence', 'Changing opinions', 'Ignoring all info'], optionsKa: ['დამადასტურებელი ინფორმაციის ძიება', 'ყველა მტკიცებულების განხილვა', 'მოსაზრებების შეცვლა', 'ყველა ინფორმაციის იგნორირება'], correctIndex: 0, explanation: 'We search for info confirming our beliefs.', explanationKa: 'ჩვენ ვეძებთ ინფორმაციას, რომელიც ადასტურებს ჩვენს რწმენას.' },
      { id: 'q8-3', question: 'Gardner proposed:', questionKa: 'გარდნერმა შემოგვთავაზა:', options: ['Single intelligence', 'Multiple intelligences', 'IQ is meaningless', 'Emotional intelligence only'], optionsKa: ['ერთიანი ინტელექტი', 'მრავლობითი ინტელექტი', 'IQ უაზროა', 'მხოლოდ ემოციური ინტელექტი'], correctIndex: 1, explanation: 'Multiple types of intelligence.', explanationKa: 'ინტელექტის მრავალი ტიპი.' },
      { id: 'q8-4', question: 'Sapir-Whorf hypothesis:', questionKa: 'საპირ-უორფის ჰიპოთეზა:', options: ['Language has no effect', 'Language influences thinking', 'Languages are identical', 'Thought determines language'], optionsKa: ['ენას ეფექტი არ აქვს', 'ენა გავლენას ახდენს აზროვნებაზე', 'ენები იდენტურია', 'აზროვნება განსაზღვრავს ენას'], correctIndex: 1, explanation: 'Language shapes perception and thinking.', explanationKa: 'ენა აყალიბებს აღქმასა და აზროვნებას.' },
      { id: 'q8-5', question: 'IQ 100 means:', questionKa: 'IQ 100 ნიშნავს:', options: ['Genius', 'Below average', 'Average', 'Disability'], optionsKa: ['გენიოსობას', 'საშუალოზე დაბალს', 'საშუალოს', 'უუნარობას'], correctIndex: 2, explanation: 'IQ 100 is the average.', explanationKa: 'IQ 100 არის საშუალო.' },
      { id: 'q8-6', question: 'Functional fixedness is:', questionKa: 'ფუნქციური ფიქსირება არის:', options: ['Seeing only typical uses', 'Great problem-solving', 'Math skill', 'Learning disability'], optionsKa: ['მხოლოდ ტიპიური გამოყენების დანახვა', 'შესანიშნავი პრობლემის გადაჭრა', 'მათემატიკური უნარი', 'სწავლის უუნარობა'], correctIndex: 0, explanation: 'Inability to see alternative uses.', explanationKa: 'ალტერნატიული გამოყენების დანახვის უუნარობა.' },
      { id: 'q8-7', question: 'Availability heuristic bases judgments on:', questionKa: 'ხელმისაწვდომობის ევრისტიკა მსჯელობას აფუძნებს:', options: ['Logic', 'Ease of recall', 'Expert opinions', 'Random chance'], optionsKa: ['ლოგიკაზე', 'გახსენების სიმარტივეზე', 'ექსპერტთა მოსაზრებებზე', 'შემთხვევითობაზე'], correctIndex: 1, explanation: 'Judgments based on how easily examples come to mind.', explanationKa: 'მსჯელობა იმაზეა დაფუძნებული, რამდენად ადვილად ახსენდება მაგალითები.' },
      { id: 'q8-8', question: 'Sternberg\'s triarchic theory:', questionKa: 'სტერნბერგის ტრიარქიული თეორია:', options: ['Verbal, math, spatial', 'Analytical, creative, practical', 'Musical, kinesthetic, interpersonal', 'Emotional, social, rational'], optionsKa: ['ვერბალური, მათემატიკური, სივრცული', 'ანალიტიკური, შემოქმედებითი, პრაქტიკული', 'მუსიკალური, კინესთეტიკური, ინტერპერსონალური', 'ემოციური, სოციალური, რაციონალური'], correctIndex: 1, explanation: 'Analytical, creative, and practical intelligence.', explanationKa: 'ანალიტიკური, შემოქმედებითი და პრაქტიკული ინტელექტი.' },
      { id: 'q8-9', question: 'Algorithms vs heuristics:', questionKa: 'ალგორითმები ევრისტიკების წინააღმდეგ:', options: ['Faster', 'Guarantee correct solution', 'Are shortcuts', 'Never work'], optionsKa: ['უფრო სწრაფია', 'გარანტირებულია სწორი გადაწყვეტა', 'მალსახმობებია', 'არასოდეს მუშაობს'], correctIndex: 1, explanation: 'Algorithms guarantee a solution.', explanationKa: 'ალგორითმები გარანტიას იძლევიან გადაწყვეტაზე.' },
      { id: 'q8-10', question: 'The Flynn effect:', questionKa: 'ფლინის ეფექტი:', options: ['Declining IQ', 'Rising IQ over generations', 'Stable IQ', 'Gender IQ differences'], optionsKa: ['IQ-ს კლება', 'IQ-ს ზრდა თაობიდან თაობამდე', 'სტაბილური IQ', 'სქესობრივი IQ განსხვავებები'], correctIndex: 1, explanation: 'IQ scores rise across generations.', explanationKa: 'IQ ქულები იზრდება თაობებს შორის.' }
    ]
  },
  {
    id: 'ch9-quiz', chapterId: 9, title: 'Human Development \u2014 Quiz', titleKa: 'ადამიანის განვითარება \u2014 ვიქტორინა',
    questions: [
      { id: 'q9-1', question: 'Object permanence is in Piaget\'s:', questionKa: 'ობიექტის მუდმივობა არის პიაჟეს:', options: ['Preoperational', 'Sensorimotor', 'Concrete operational', 'Formal operational'], optionsKa: ['პრეოპერაციული', 'სენსომოტორული', 'კონკრეტული ოპერაციული', 'ფორმალური ოპერაციული'], correctIndex: 1, explanation: 'Develops in the sensorimotor stage.', explanationKa: 'ვითარდება სენსომოტორულ სტადიაზე.' },
      { id: 'q9-2', question: 'Erikson\'s identity crisis occurs in:', questionKa: 'ერიქსონის იდენტობის კრიზისი ხდება:', options: ['Infancy', 'Early childhood', 'Adolescence', 'Adulthood'], optionsKa: ['ჩვილობაში', 'ადრეულ ბავშვობაში', 'მოზარდობაში', 'ზრდასრულობაში'], correctIndex: 2, explanation: 'Identity vs. role confusion in adolescence.', explanationKa: 'იდენტობა როლური დაბნეულობის წინააღმდეგ მოზარდობაში.' },
      { id: 'q9-3', question: 'Secure attachment was described by:', questionKa: 'უსაფრთხო მიბმულობა აღწერა:', options: ['Freud', 'Ainsworth', 'Piaget', 'Skinner'], optionsKa: ['ფროიდმა', 'ეინსვორთმა', 'პიაჟემ', 'სკინერმა'], correctIndex: 1, explanation: 'Ainsworth identified attachment styles.', explanationKa: 'ეინსვორთმა გამოავლინა მიბმულობის სტილები.' },
      { id: 'q9-4', question: 'ZPD was proposed by:', questionKa: 'უახლოესი განვითარების ზონა (ZPD) შემოგვთავაზა:', options: ['Piaget', 'Vygotsky', 'Erikson', 'Kohlberg'], optionsKa: ['პიაჟემ', 'ვიგოტსკიმ', 'ერიქსონმა', 'კოლბერგმა'], correctIndex: 1, explanation: 'Vygotsky proposed the Zone of Proximal Development.', explanationKa: 'ვიგოტსკიმ შემოგვთავაზა უახლოესი განვითარების ზონა.' },
      { id: 'q9-5', question: 'Kohlberg focuses on:', questionKa: 'კოლბერგი ფოკუსირდება:', options: ['Cognitive development', 'Moral development', 'Physical development', 'Emotional development'], optionsKa: ['კოგნიტურ განვითარებაზე', 'მორალურ განვითარებაზე', 'ფიზიკურ განვითარებაზე', 'ემოციურ განვითარებაზე'], correctIndex: 1, explanation: 'Three levels of moral reasoning.', explanationKa: 'მორალური მსჯელობის სამი დონე.' },
      { id: 'q9-6', question: 'Preoperational children show:', questionKa: 'პრეოპერაციული ბავშვები ავლენენ:', options: ['Abstract thinking', 'Egocentrism', 'Conservation', 'Logical reasoning'], optionsKa: ['აბსტრაქტულ აზროვნებას', 'ეგოცენტრიზმს', 'კონსერვაციას', 'ლოგიკურ მსჯელობას'], correctIndex: 1, explanation: 'Egocentrism and symbolic play.', explanationKa: 'ეგოცენტრიზმი და სიმბოლური თამაში.' },
      { id: 'q9-7', question: 'Teratogens are:', questionKa: 'ტერატოგენები არის:', options: ['Vitamins', 'Harmful agents causing birth defects', 'Genes', 'Hormones'], optionsKa: ['ვიტამინები', 'მავნე აგენტები, რომლებიც იწვევენ თანდაყოლილ დეფექტებს', 'გენები', 'ჰორმონები'], correctIndex: 1, explanation: 'Substances that harm prenatal development.', explanationKa: 'ნივთიერებები, რომლებიც აზიანებენ პრენატალურ განვითარებას.' },
      { id: 'q9-8', question: 'Harlow showed importance of:', questionKa: 'ჰარლოუმ აჩვენა მნიშვნელობა:', options: ['Food over comfort', 'Contact comfort', 'Primate intelligence', 'Visual learning'], optionsKa: ['საკვები კომფორტზე მეტია', 'კონტაქტური კომფორტი', 'პრიმატების ინტელექტი', 'ვიზუალური სწავლა'], correctIndex: 1, explanation: 'Contact comfort matters more than food.', explanationKa: 'კონტაქტური კომფორტი უფრო მნიშვნელოვანია, ვიდრე საკვები.' },
      { id: 'q9-9', question: 'Conservation means:', questionKa: 'კონსერვაცია ნიშნავს:', options: ['Protecting nature', 'Quantity stays same despite shape change', 'Memory rehearsal', 'Energy limit'], optionsKa: ['ბუნების დაცვას', 'რაოდენობა იგივე რჩება ფორმის ცვლილების მიუხედავად', 'მეხსიერების გამეორებას', 'ენერგიის ლიმიტს'], correctIndex: 1, explanation: 'Properties remain constant despite appearance.', explanationKa: 'თვისებები მუდმივი რჩება გარეგნობის მიუხედავად.' },
      { id: 'q9-10', question: 'Erikson\'s first crisis:', questionKa: 'ერიქსონის პირველი კრიზისი:', options: ['Autonomy vs. shame', 'Trust vs. mistrust', 'Initiative vs. guilt', 'Industry vs. inferiority'], optionsKa: ['ავტონომია სირცხვილის წინააღმდეგ', 'ნდობა უნდობლობის წინააღმდეგ', 'ინიციატივა დანაშაულის წინააღმდეგ', 'შრომისმოყვარეობა არასრულფასოვნების წინააღმდეგ'], correctIndex: 1, explanation: 'Trust vs. mistrust in infancy.', explanationKa: 'ნდობა უნდობლობის წინააღმდეგ ჩვილობაში.' }
    ]
  },
  {
    id: 'ch10-quiz', chapterId: 10, title: 'Motivation and Emotion \u2014 Quiz', titleKa: 'მოტივაცია და ემოცია \u2014 ვიქტორინა',
    questions: [
      { id: 'q10-1', question: 'Top of Maslow\'s hierarchy:', questionKa: 'მასლოუს იერარქიის ზედა:', options: ['Safety', 'Esteem', 'Self-actualization', 'Love'], optionsKa: ['უსაფრთხოება', 'პატივისცემა', 'თვითრეალიზაცია', 'სიყვარული'], correctIndex: 2, explanation: 'Self-actualization is the highest level.', explanationKa: 'თვითრეალიზაცია ყველაზე მაღალი დონეა.' },
      { id: 'q10-2', question: 'James-Lange theory:', questionKa: 'ჯეიმს-ლანგეს თეორია:', options: ['Emotions cause physical response', 'Physical response causes emotions', 'They occur simultaneously', 'Emotions are cognitive'], optionsKa: ['ემოციები იწვევს ფიზიკურ რეაქციას', 'ფიზიკური რეაქცია იწვევს ემოციებს', 'ისინი ერთდროულად ხდება', 'ემოციები კოგნიტურია'], correctIndex: 1, explanation: 'We feel emotions because of body responses.', explanationKa: 'ემოციებს ვგრძნობთ სხეულის რეაქციების გამო.' },
      { id: 'q10-3', question: 'Intrinsic motivation comes from:', questionKa: 'შინაგანი მოტივაცია მოდის:', options: ['External rewards', 'Internal satisfaction', 'Social pressure', 'Money'], optionsKa: ['გარეგანი ჯილდოებიდან', 'შინაგანი კმაყოფილებიდან', 'სოციალური ზეწოლიდან', 'ფულიდან'], correctIndex: 1, explanation: 'Internal enjoyment and satisfaction.', explanationKa: 'შინაგანი სიამოვნება და კმაყოფილება.' },
      { id: 'q10-4', question: 'Set-point theory says:', questionKa: 'მითითების წერტილის თეორია ამბობს:', options: ['Body maintains a natural weight range', 'Eat anything freely', 'Metabolism irrelevant', 'Exercise unnecessary'], optionsKa: ['სხეული ინარჩუნებს ბუნებრივ წონის დიაპაზონს', 'ჭამეთ რაც გინდათ', 'მეტაბოლიზმი არაარსებითია', 'ვარჯიში არ არის საჭირო'], correctIndex: 0, explanation: 'Body works to maintain a natural weight range.', explanationKa: 'სხეული მუშაობს ბუნებრივი წონის დიაპაზონის შესანარჩუნებლად.' },
      { id: 'q10-5', question: 'Ekman found emotions are:', questionKa: 'ეკმანმა აღმოაჩინა, რომ ემოციები არის:', options: ['Culturally unique', 'Universal', 'Only learned', 'Different everywhere'], optionsKa: ['კულტურულად უნიკალური', 'უნივერსალური', 'მხოლოდ ნასწავლი', 'ყველგან განსხვავებული'], correctIndex: 1, explanation: 'Basic expressions are universal.', explanationKa: 'ძირითადი გამოხატულებები უნივერსალურია.' },
      { id: 'q10-6', question: 'Yerkes-Dodson law:', questionKa: 'იერქს-დოდსონის კანონი:', options: ['More arousal better', 'Moderate arousal optimal', 'Low arousal best', 'Arousal irrelevant'], optionsKa: ['მეტი აგზნება უკეთესია', 'ზომიერი აგზნება ოპტიმალურია', 'დაბალი აგზნება საუკეთესოა', 'აგზნება არაარსებითია'], correctIndex: 1, explanation: 'Moderate arousal leads to optimal performance.', explanationKa: 'ზომიერი აგზნება იწვევს ოპტიმალურ შესრულებას.' },
      { id: 'q10-7', question: 'Cannon-Bard says:', questionKa: 'კენონ-ბარდის თეორია ამბობს:', options: ['Body causes emotions', 'Emotions and arousal occur simultaneously', 'We label arousal', 'Emotions unnecessary'], optionsKa: ['სხეული იწვევს ემოციებს', 'ემოციები და აგზნება ერთდროულად ხდება', 'ჩვენ აგზნებას ვასახელებთ', 'ემოციები არ არის საჭირო'], correctIndex: 1, explanation: 'Experience and arousal happen simultaneously.', explanationKa: 'განცდა და აგზნება ერთდროულად ხდება.' },
      { id: 'q10-8', question: 'Overjustification effect:', questionKa: 'ზედმეტი გამართლების ეფექტი:', options: ['External rewards decrease intrinsic motivation', 'Too much motivation fails', 'More money more effort', 'Emotions too strong'], optionsKa: ['გარეგანი ჯილდოები ამცირებს შინაგან მოტივაციას', 'ზედმეტი მოტივაცია ვერ ხერხდება', 'მეტი ფული მეტი ძალისხმევა', 'ემოციები ძალიან ძლიერია'], correctIndex: 0, explanation: 'External rewards can reduce intrinsic motivation.', explanationKa: 'გარეგანმა ჯილდოებმა შეიძლება შეამციროს შინაგანი მოტივაცია.' },
      { id: 'q10-9', question: 'Which theory: label arousal to identify emotions?', questionKa: 'რომელი თეორია: აგზნების იარლიყი ემოციების იდენტიფიცირებისთვის?', options: ['James-Lange', 'Cannon-Bard', 'Schachter-Singer', 'Evolutionary'], optionsKa: ['ჯეიმს-ლანგე', 'კენონ-ბარდი', 'შეხტერ-სინგერი', 'ევოლუციური'], correctIndex: 2, explanation: 'Emotion = arousal + cognitive label.', explanationKa: 'ემოცია = აგზნება + კოგნიტური იარლიყი.' },
      { id: 'q10-10', question: 'Maslow is known for:', questionKa: 'მასლოუ ცნობილია:', options: ['Behaviorism', 'Hierarchy of needs', 'Psychoanalysis', 'CBT'], optionsKa: ['ბიჰევიორიზმით', 'მოთხოვნილებათა იერარქიით', 'ფსიქოანალიზით', 'კოგნიტურ-ბიჰევიორული თერაპიით'], correctIndex: 1, explanation: 'The hierarchy of needs.', explanationKa: 'მოთხოვნილებათა იერარქია.' }
    ]
  },
  {
    id: 'ch11-quiz', chapterId: 11, title: 'Personality \u2014 Quiz', titleKa: 'პიროვნება \u2014 ვიქტორინა',
    questions: [
      { id: 'q11-1', question: 'Freud\'s id operates on:', questionKa: 'ფროიდის იდი მოქმედებს:', options: ['Reality principle', 'Pleasure principle', 'Moral principle', 'Social principle'], optionsKa: ['რეალობის პრინციპით', 'სიამოვნების პრინციპით', 'მორალური პრინციპით', 'სოციალური პრინციპით'], correctIndex: 1, explanation: 'Id seeks immediate gratification.', explanationKa: 'იდი ეძებს მყისიერ დაკმაყოფილებას.' },
      { id: 'q11-2', question: 'Big Five excludes:', questionKa: 'დიდ ხუთეულში არ შედის:', options: ['Openness', 'Conscientiousness', 'Intelligence', 'Neuroticism'], optionsKa: ['გახსნილობა', 'კეთილსინდისიერება', 'ინტელექტი', 'ნევროტიზმი'], correctIndex: 2, explanation: 'Intelligence is not a Big Five trait.', explanationKa: 'ინტელექტი არ არის დიდი ხუთეულის თვისება.' },
      { id: 'q11-3', question: 'Rogers emphasized:', questionKa: 'როჯერსი ხაზს უსვამდა:', options: ['Defense mechanisms', 'Unconditional positive regard', 'Conditioning', 'Dream analysis'], optionsKa: ['დაცვის მექანიზმებს', 'უპირობო პოზიტიურ მიღებას', 'კონდიციონირებას', 'სიზმრების ანალიზს'], correctIndex: 1, explanation: 'Unconditional positive regard is essential.', explanationKa: 'უპირობო პოზიტიური მიღება აუცილებელია.' },
      { id: 'q11-4', question: 'Projection means:', questionKa: 'პროექცია ნიშნავს:', options: ['Denying reality', 'Attributing own feelings to others', 'Returning to earlier stage', 'Channeling impulses'], optionsKa: ['რეალობის უარყოფა', 'საკუთარი გრძნობების სხვებზე გადატანა', 'ადრეულ სტადიაზე დაბრუნება', 'იმპულსების მიმართვა'], correctIndex: 1, explanation: 'Projecting unacceptable feelings onto others.', explanationKa: 'მიუღებელი გრძნობების სხვებზე გადატანა.' },
      { id: 'q11-5', question: 'Self-efficacy refers to:', questionKa: 'თვითეფექტურობა ეხება:', options: ['Self-esteem', 'Belief in ability to succeed', 'Personality type', 'Intelligence'], optionsKa: ['თვითშეფასებას', 'წარმატების უნარის რწმენას', 'პიროვნების ტიპს', 'ინტელექტს'], correctIndex: 1, explanation: 'Belief in capability to perform.', explanationKa: 'შესრულების უნარის რწმენა.' },
      { id: 'q11-6', question: 'Freud\'s stages exclude:', questionKa: 'ფროიდის სტადიებში არ შედის:', options: ['Oral', 'Anal', 'Cognitive', 'Phallic'], optionsKa: ['ორალური', 'ანალური', 'კოგნიტური', 'ფალიკური'], correctIndex: 2, explanation: 'Cognitive is Piaget, not Freud.', explanationKa: 'კოგნიტური პიაჟეს ეკუთვნის, არა ფროიდს.' },
      { id: 'q11-7', question: 'Rorschach test uses:', questionKa: 'რორშახის ტესტი იყენებს:', options: ['True/false', 'Inkblots', 'Sentences', 'Drawings'], optionsKa: ['ჭეშმარიტი/მცდარი', 'მელნის ლაქებს', 'წინადადებებს', 'ნახატებს'], correctIndex: 1, explanation: 'Ambiguous inkblots for personality assessment.', explanationKa: 'ორაზროვანი მელნის ლაქები პიროვნების შეფასებისთვის.' },
      { id: 'q11-8', question: 'Ego operates on:', questionKa: 'ეგო მოქმედებს:', options: ['Pleasure principle', 'Moral principle', 'Reality principle', 'Unconscious'], optionsKa: ['სიამოვნების პრინციპით', 'მორალური პრინციპით', 'რეალობის პრინციპით', 'არაცნობიერით'], correctIndex: 2, explanation: 'Ego mediates between id and reality.', explanationKa: 'ეგო შუამავლობს იდსა და რეალობას შორის.' },
      { id: 'q11-9', question: 'Locus of control:', questionKa: 'კონტროლის ლოკუსი:', options: ['Brain location', 'Whether outcomes are internal or external', 'Coordination', 'Self-esteem'], optionsKa: ['ტვინის მდებარეობა', 'შედეგები შინაგანია თუ გარეგანი', 'კოორდინაცია', 'თვითშეფასება'], correctIndex: 1, explanation: 'Internal vs external locus.', explanationKa: 'შინაგანი წინააღმდეგ გარეგანი ლოკუსი.' },
      { id: 'q11-10', question: 'Adler proposed:', questionKa: 'ადლერმა შემოგვთავაზა:', options: ['Collective unconscious', 'Inferiority complex', 'Self-actualization', 'Operant conditioning'], optionsKa: ['კოლექტიური არაცნობიერი', 'არასრულფასოვნების კომპლექსი', 'თვითრეალიზაცია', 'ოპერანტული კონდიციონირება'], correctIndex: 1, explanation: 'Inferiority feelings motivate growth.', explanationKa: 'არასრულფასოვნების გრძნობა ზრდას აღძრავს.' }
    ]
  },
  {
    id: 'ch12-quiz', chapterId: 12, title: 'Social Psychology \u2014 Quiz', titleKa: 'სოციალური ფსიქოლოგია \u2014 ვიქტორინა',
    questions: [
      { id: 'q12-1', question: 'Asch tested conformity with:', questionKa: 'აშმა კონფორმიზმი შეამოწმა:', options: ['Colors', 'Line lengths', 'Sounds', 'Weights'], optionsKa: ['ფერებით', 'ხაზების სიგრძეებით', 'ხმებით', 'წონებით'], correctIndex: 1, explanation: 'Participants conformed about line lengths.', explanationKa: 'მონაწილეები ხაზების სიგრძეებზე ეთანხმებოდნენ.' },
      { id: 'q12-2', question: 'Milgram found:', questionKa: 'მილგრამმა აღმოაჩინა:', options: ['Refused to shock', 'Often obeyed authority', 'Never followed orders', 'Enjoyed it'], optionsKa: ['უარს ამბობდნენ შოკზე', 'ხშირად ემორჩილებოდნენ ავტორიტეტს', 'არასდროს მისდევდნენ ბრძანებებს', 'სიამოვნებას იღებდნენ'], correctIndex: 1, explanation: '65% obeyed authority.', explanationKa: '65% ემორჩილებოდა ავტორიტეტს.' },
      { id: 'q12-3', question: 'Bystander effect:', questionKa: 'თვითმხილველის ეფექტი:', options: ['More bystanders help', 'Less likely to help with others present', 'Only men help', 'Crowd size helps'], optionsKa: ['მეტი თვითმხილველი ეხმარება', 'ნაკლებად სავარაუდოა დახმარება სხვების თანდასწრებით', 'მხოლოდ მამაკაცები ეხმარებიან', 'ბრბოს ზომა ხელს უწყობს'], correctIndex: 1, explanation: 'Diffusion of responsibility.', explanationKa: 'პასუხისმგებლობის გაბნევა.' },
      { id: 'q12-4', question: 'Cognitive dissonance:', questionKa: 'კოგნიტური დისონანსი:', options: ['Attitude-behavior agreement', 'Discomfort from contradictions', 'Memory error', 'Personality disorder'], optionsKa: ['დამოკიდებულება-ქცევის თანხმობა', 'დისკომფორტი წინააღმდეგობებიდან', 'მეხსიერების შეცდომა', 'პიროვნული აშლილობა'], correctIndex: 1, explanation: 'Discomfort when attitudes conflict with behavior.', explanationKa: 'დისკომფორტი, როცა დამოკიდებულებები ქცევას ეწინააღმდეგება.' },
      { id: 'q12-5', question: 'Fundamental attribution error:', questionKa: 'ფუნდამენტური ატრიბუციის შეცდომა:', options: ['Overestimate situation', 'Overestimate personality for others', 'Equal weighing', 'Self-blame'], optionsKa: ['სიტუაციის გადაჭარბებული შეფასება', 'სხვების პიროვნების გადაჭარბებული შეფასება', 'თანაბარი შეწონვა', 'თვითდადანაშაულება'], correctIndex: 1, explanation: 'We overemphasize others\' traits.', explanationKa: 'სხვების თვისებებს ზედმეტად ხაზს ვუსვამთ.' },
      { id: 'q12-6', question: 'Stanford Prison Experiment by:', questionKa: 'სტენფორდის ციხის ექსპერიმენტი ჩაატარა:', options: ['Milgram', 'Asch', 'Zimbardo', 'Bandura'], optionsKa: ['მილგრამმა', 'აშმა', 'ზიმბარდომ', 'ბანდურამ'], correctIndex: 2, explanation: 'Philip Zimbardo conducted it.', explanationKa: 'ფილიპ ზიმბარდომ ჩაატარა.' },
      { id: 'q12-7', question: 'Groupthink leads to:', questionKa: 'ჯგუფური აზროვნება იწვევს:', options: ['Better decisions', 'Poor decisions from harmony desire', 'Creativity', 'Individuality'], optionsKa: ['უკეთეს გადაწყვეტილებებს', 'ცუდ გადაწყვეტილებებს ჰარმონიის სურვილიდან', 'შემოქმედებას', 'ინდივიდუალობას'], correctIndex: 1, explanation: 'Consensus overrides realistic appraisal.', explanationKa: 'კონსენსუსი გადაფარავს რეალისტურ შეფასებას.' },
      { id: 'q12-8', question: 'Mere exposure effect:', questionKa: 'მარტივი ზემოქმედების ეფექტი:', options: ['Dislike familiar things', 'Repeated exposure increases liking', 'First impressions only', 'Advertising fails'], optionsKa: ['ნაცნობი რამის არმოწონება', 'განმეორებითი ზემოქმედება ზრდის მოწონებას', 'მხოლოდ პირველი შთაბეჭდილება', 'რეკლამა ვერ მუშაობს'], correctIndex: 1, explanation: 'Familiarity increases liking.', explanationKa: 'ნაცნობობა ზრდის მოწონებას.' },
      { id: 'q12-9', question: 'Social loafing:', questionKa: 'სოციალური სიზარმაცე:', options: ['Working harder in groups', 'Less effort in groups', 'Leadership', 'Role confusion'], optionsKa: ['ჯგუფებში მეტი მუშაობა', 'ჯგუფებში ნაკლები ძალისხმევა', 'ლიდერობა', 'როლის აღრევა'], correctIndex: 1, explanation: 'People exert less effort in groups.', explanationKa: 'ადამიანები ჯგუფებში ნაკლებ ძალისხმევას გასწევენ.' },
      { id: 'q12-10', question: 'Deindividuation:', questionKa: 'დეინდივიდუაცია:', options: ['More self-aware', 'Lose self-awareness in groups', 'Groups become cautious', 'Individuals lead'], optionsKa: ['მეტი თვითშეგნება', 'ჯგუფში თვითშეგნების დაკარგვა', 'ჯგუფები ხდება ფრთხილი', 'ინდივიდები ხელმძღვანელობენ'], correctIndex: 1, explanation: 'Loss of self-awareness in group situations.', explanationKa: 'თვითშეგნების დაკარგვა ჯგუფურ სიტუაციებში.' }
    ]
  },
  {
    id: 'ch13-quiz', chapterId: 13, title: 'Stress and Coping \u2014 Quiz', titleKa: 'სტრესი და გამკლავება \u2014 ვიქტორინა',
    questions: [
      { id: 'q13-1', question: 'GAS stages:', questionKa: 'ზოგადი ადაპტაციის სინდრომის სტადიები:', options: ['Start, middle, end', 'Alarm, resistance, exhaustion', 'Stress, cope, recover', 'Fight, flight, freeze'], optionsKa: ['დასაწყისი, შუა, დასასრული', 'განგაში, წინააღმდეგობა, გამოფიტვა', 'სტრესი, გამკლავება, აღდგენა', 'ბრძოლა, გაქცევა, გაყინვა'], correctIndex: 1, explanation: 'Alarm, resistance, exhaustion.', explanationKa: 'განგაში, წინააღმდეგობა, გამოფიტვა.' },
      { id: 'q13-2', question: 'Type A personality:', questionKa: 'A ტიპის პიროვნება:', options: ['Relaxed', 'Competitive, urgent, hostile', 'Introverted', 'Low motivation'], optionsKa: ['მოდუნებული', 'კონკურენტუნარიანი, სასწრაფო, მტრული', 'ინტროვერტული', 'დაბალი მოტივაცია'], correctIndex: 1, explanation: 'Type A: competitive and time-pressured.', explanationKa: 'A ტიპი: კონკურენტუნარიანი და დროით შეზღუდული.' },
      { id: 'q13-3', question: 'Problem-focused coping:', questionKa: 'პრობლემაზე ორიენტირებული გამკლავება:', options: ['Managing emotions', 'Addressing the stressor directly', 'Avoiding', 'Denial'], optionsKa: ['ემოციების მართვა', 'სტრესორთან პირდაპირი მუშაობა', 'თავის არიდება', 'უარყოფა'], correctIndex: 1, explanation: 'Directly tackling the problem.', explanationKa: 'პრობლემის პირდაპირ მოგვარება.' },
      { id: 'q13-4', question: 'Immune system weakened by:', questionKa: 'იმუნური სისტემა სუსტდება:', options: ['Exercise', 'Chronic stress', 'Good nutrition', 'Sleep'], optionsKa: ['ვარჯიშით', 'ქრონიკული სტრესით', 'კარგი კვებით', 'ძილით'], correctIndex: 1, explanation: 'Chronic stress suppresses immunity.', explanationKa: 'ქრონიკული სტრესი თრგუნავს იმუნიტეტს.' },
      { id: 'q13-5', question: 'Burnout features:', questionKa: 'გადაწვის მახასიათებლები:', options: ['High energy', 'Exhaustion and depersonalization', 'Physical injury', 'Productivity'], optionsKa: ['მაღალი ენერგია', 'გამოფიტვა და დეპერსონალიზაცია', 'ფიზიკური ტრავმა', 'პროდუქტიულობა'], correctIndex: 1, explanation: 'Emotional exhaustion and cynicism.', explanationKa: 'ემოციური გამოფიტვა და ცინიზმი.' },
      { id: 'q13-6', question: 'Social support helps by:', questionKa: 'სოციალური მხარდაჭერა ეხმარება:', options: ['Eliminating stress', 'Providing emotional and practical help', 'Replacing medicine', 'Raising blood pressure'], optionsKa: ['სტრესის აღმოფხვრით', 'ემოციური და პრაქტიკული დახმარებით', 'მედიკამენტების ჩანაცვლებით', 'არტერიული წნევის ამაღლებით'], correctIndex: 1, explanation: 'Providing emotional comfort and practical help.', explanationKa: 'ემოციური კომფორტისა და პრაქტიკული დახმარების მიწოდება.' },
      { id: 'q13-7', question: 'Cortisol comes from:', questionKa: 'კორტიზოლი მოდის:', options: ['Thyroid', 'Adrenal glands', 'Pituitary', 'Pineal'], optionsKa: ['ფარისებრი ჯირკვლიდან', 'თირკმელზედა ჯირკვლებიდან', 'ჰიპოფიზიდან', 'ეპიფიზიდან'], correctIndex: 1, explanation: 'Adrenal glands produce cortisol.', explanationKa: 'თირკმელზედა ჯირკვლები აწარმოებს კორტიზოლს.' },
      { id: 'q13-8', question: 'Emotion-focused coping:', questionKa: 'ემოციაზე ორიენტირებული გამკლავება:', options: ['Making a plan', 'Relaxation and emotional support', 'Solving problem', 'Confronting'], optionsKa: ['გეგმის შედგენა', 'რელაქსაცია და ემოციური მხარდაჭერა', 'პრობლემის გადაჭრა', 'დაპირისპირება'], correctIndex: 1, explanation: 'Managing emotional response to stress.', explanationKa: 'სტრესზე ემოციური რეაქციის მართვა.' },
      { id: 'q13-9', question: 'Daily hassles vs. major events:', questionKa: 'ყოველდღიური სირთულეები vs მთავარი მოვლენები:', options: ['Only major events matter', 'Hassles can be equally harmful', 'Hassles irrelevant', 'Major events no impact'], optionsKa: ['მხოლოდ მთავარი მოვლენებია მნიშვნელოვანი', 'სირთულეები თანაბრად საზიანო შეიძლება იყოს', 'სირთულეები არაარსებითია', 'მთავარ მოვლენებს გავლენა არ აქვს'], correctIndex: 1, explanation: 'Accumulated hassles are very harmful.', explanationKa: 'დაგროვილი სირთულეები ძალიან საზიანოა.' },
      { id: 'q13-10', question: 'Resilience:', questionKa: 'გამძლეობა:', options: ['Avoiding all stress', 'Recovery after adversity', 'Physical toughness', 'No negative emotions'], optionsKa: ['ყველა სტრესის თავიდან აცილება', 'გაჭირვების შემდეგ აღდგენა', 'ფიზიკური სიმტკიცე', 'უარყოფითი ემოციების არქონა'], correctIndex: 1, explanation: 'Capacity to recover and adapt.', explanationKa: 'აღდგენისა და ადაპტაციის უნარი.' }
    ]
  },
  {
    id: 'ch14-quiz', chapterId: 14, title: 'Psychological Disorders \u2014 Quiz', titleKa: 'ფსიქოლოგიური აშლილობები \u2014 ვიქტორინა',
    questions: [
      { id: 'q14-1', question: 'DSM-5 is:', questionKa: 'DSM-5 არის:', options: ['Therapy technique', 'Diagnostic manual', 'Medication', 'Test'], optionsKa: ['თერაპიის ტექნიკა', 'დიაგნოსტიკური სახელმძღვანელო', 'მედიკამენტი', 'ტესტი'], correctIndex: 1, explanation: 'Standard classification for mental disorders.', explanationKa: 'ფსიქიკური აშლილობების სტანდარტული კლასიფიკაცია.' },
      { id: 'q14-2', question: 'Major depression involves:', questionKa: 'დიდი დეპრესია მოიცავს:', options: ['Brief sadness', 'Persistent depressed mood 2+ weeks', 'Constant happiness', 'Physical only'], optionsKa: ['ხანმოკლე სევდას', 'მუდმივ დეპრესიულ განწყობას 2+ კვირა', 'მუდმივ ბედნიერებას', 'მხოლოდ ფიზიკურს'], correctIndex: 1, explanation: 'At least two weeks of depressed mood.', explanationKa: 'მინიმუმ ორი კვირის დეპრესიული განწყობა.' },
      { id: 'q14-3', question: 'Schizophrenia features:', questionKa: 'შიზოფრენიის მახასიათებლები:', options: ['Multiple personalities', 'Hallucinations and delusions', 'Extreme anxiety', 'Memory loss only'], optionsKa: ['მრავალი პიროვნება', 'ჰალუცინაციები და ბოდვები', 'ექსტრემალური შფოთვა', 'მხოლოდ მეხსიერების დაკარგვა'], correctIndex: 1, explanation: 'Hallucinations, delusions, disordered thinking.', explanationKa: 'ჰალუცინაციები, ბოდვები, მოუწესრიგებელი აზროვნება.' },
      { id: 'q14-4', question: 'A phobia is:', questionKa: 'ფობია არის:', options: ['Normal fear', 'Irrational excessive fear', 'Temporary anxiety', 'Mood disorder'], optionsKa: ['ნორმალური შიში', 'ირაციონალური ზედმეტი შიში', 'დროებითი შფოთვა', 'განწყობის აშლილობა'], correctIndex: 1, explanation: 'Intense, irrational fears.', explanationKa: 'ინტენსიური, ირაციონალური შიშები.' },
      { id: 'q14-5', question: 'Bipolar disorder:', questionKa: 'ბიპოლარული აშლილობა:', options: ['Only depression', 'Alternating mania and depression', 'Constant mania', 'Anxiety'], optionsKa: ['მხოლოდ დეპრესია', 'მანიისა და დეპრესიის მონაცვლეობა', 'მუდმივი მანია', 'შფოთვა'], correctIndex: 1, explanation: 'Alternating manic and depressive episodes.', explanationKa: 'მანიაკალური და დეპრესიული ეპიზოდების მონაცვლეობა.' },
      { id: 'q14-6', question: 'PTSD develops after:', questionKa: 'PTSD ვითარდება:', options: ['Mild stress', 'Traumatic event', 'Normal bad day', 'Puberty'], optionsKa: ['მსუბუქი სტრესის შემდეგ', 'ტრავმული მოვლენის შემდეგ', 'ჩვეულებრივი ცუდი დღის შემდეგ', 'პუბერტატის შემდეგ'], correctIndex: 1, explanation: 'Following traumatic event exposure.', explanationKa: 'ტრავმულ მოვლენასთან შეხების შემდეგ.' },
      { id: 'q14-7', question: 'Diathesis-stress model:', questionKa: 'დიათეზ-სტრესის მოდელი:', options: ['Only genetics', 'Only environment', 'Predisposition + stress', 'Random chance'], optionsKa: ['მხოლოდ გენეტიკა', 'მხოლოდ გარემო', 'მიდრეკილება + სტრესი', 'შემთხვევითობა'], correctIndex: 2, explanation: 'Vulnerability interacts with stress.', explanationKa: 'მოწყვლადობა ურთიერთქმედებს სტრესთან.' },
      { id: 'q14-8', question: 'OCD involves:', questionKa: 'ობსესიურ-კომპულსიური აშლილობა მოიცავს:', options: ['Obsessions and compulsions', 'Only sadness', 'Social withdrawal', 'Memory loss'], optionsKa: ['ობსესიებს და კომპულსიებს', 'მხოლოდ სევდას', 'სოციალურ იზოლაციას', 'მეხსიერების დაკარგვას'], correctIndex: 0, explanation: 'Intrusive thoughts and repetitive behaviors.', explanationKa: 'ინტრუზიული აზრები და განმეორებადი ქცევები.' },
      { id: 'q14-9', question: 'GAD is:', questionKa: 'გენერალიზებული შფოთვის აშლილობა არის:', options: ['Specific fears', 'Excessive worry about many things', 'Panic attacks only', 'Delusions'], optionsKa: ['კონკრეტული შიშები', 'ბევრ რამეზე ზედმეტი შეშფოთება', 'მხოლოდ პანიკის შეტევები', 'ბოდვები'], correctIndex: 1, explanation: 'Chronic, excessive worry.', explanationKa: 'ქრონიკული, ზედმეტი შეშფოთება.' },
      { id: 'q14-10', question: 'Medical model views disorders as:', questionKa: 'სამედიცინო მოდელი აშლილობებს განიხილავს როგორც:', options: ['Moral failures', 'Biological diseases', 'Personal choices', 'Spiritual'], optionsKa: ['მორალურ წარუმატებლობას', 'ბიოლოგიურ დაავადებებს', 'პირად არჩევანს', 'სულიერს'], correctIndex: 1, explanation: 'Disorders as biological illnesses.', explanationKa: 'აშლილობები როგორც ბიოლოგიური დაავადებები.' }
    ]
  },
  {
    id: 'ch15-quiz', chapterId: 15, title: 'Therapies \u2014 Quiz', titleKa: 'თერაპიები \u2014 ვიქტორინა',
    questions: [
      { id: 'q15-1', question: 'CBT focuses on:', questionKa: 'კოგნიტურ-ბიჰევიორული თერაპია ფოკუსირებულია:', options: ['Dreams', 'Changing thoughts and behaviors', 'Free association', 'Medication'], optionsKa: ['სიზმრებზე', 'აზრებისა და ქცევების შეცვლაზე', 'თავისუფალ ასოციაციაზე', 'მედიკამენტებზე'], correctIndex: 1, explanation: 'Restructuring negative thoughts and behaviors.', explanationKa: 'უარყოფითი აზრებისა და ქცევების რესტრუქტურიზაცია.' },
      { id: 'q15-2', question: 'Systematic desensitization treats:', questionKa: 'სისტემატური დესენსიტიზაცია მკურნალობს:', options: ['Depression', 'Phobias via gradual exposure', 'Schizophrenia', 'ADHD'], optionsKa: ['დეპრესიას', 'ფობიებს თანდათანობითი ზემოქმედებით', 'შიზოფრენიას', 'ADHD-ს'], correctIndex: 1, explanation: 'Gradual exposure paired with relaxation.', explanationKa: 'თანდათანობითი ზემოქმედება რელაქსაციასთან ერთად.' },
      { id: 'q15-3', question: 'Client-centered therapy by:', questionKa: 'კლიენტზე ორიენტირებული თერაპია შექმნა:', options: ['Freud', 'Skinner', 'Carl Rogers', 'Beck'], optionsKa: ['ფროიდმა', 'სკინერმა', 'კარლ როჯერსმა', 'ბეკმა'], correctIndex: 2, explanation: 'Rogers created person-centered therapy.', explanationKa: 'როჯერსმა შექმნა პიროვნებაზე ორიენტირებული თერაპია.' },
      { id: 'q15-4', question: 'SSRIs increase:', questionKa: 'SSRI-ები ზრდის:', options: ['Dopamine', 'Serotonin availability', 'All brain activity', 'Neuron death'], optionsKa: ['დოფამინს', 'სეროტონინის ხელმისაწვდომობას', 'ტვინის მთელ აქტივობას', 'ნეირონების სიკვდილს'], correctIndex: 1, explanation: 'SSRIs block serotonin reabsorption.', explanationKa: 'SSRI-ები ბლოკავს სეროტონინის ხელახალ შეწოვას.' },
      { id: 'q15-5', question: 'Free association is used in:', questionKa: 'თავისუფალი ასოციაცია გამოიყენება:', options: ['CBT', 'Behavioral', 'Psychoanalysis', 'Group therapy'], optionsKa: ['კოგნიტურ-ბიჰევიორულ თერაპიაში', 'ბიჰევიორულში', 'ფსიქოანალიზში', 'ჯგუფურ თერაპიაში'], correctIndex: 2, explanation: 'A psychoanalytic technique.', explanationKa: 'ფსიქოანალიტიკური ტექნიკა.' },
      { id: 'q15-6', question: 'Group therapy offers:', questionKa: 'ჯგუფური თერაპია სთავაზობს:', options: ['Lower cost only', 'Shared experiences and skills practice', 'Faster meds', 'Solitary healing'], optionsKa: ['მხოლოდ დაბალ ფასს', 'გაზიარებულ გამოცდილებას და უნარების პრაქტიკას', 'სწრაფ მედიკამენტებს', 'მარტოხელა განკურნებას'], correctIndex: 1, explanation: 'Peer support and social practice.', explanationKa: 'თანატოლთა მხარდაჭერა და სოციალური პრაქტიკა.' },
      { id: 'q15-7', question: 'Exposure therapy based on:', questionKa: 'ექსპოზიციური თერაპია დაფუძნებულია:', options: ['Psychoanalysis', 'Classical conditioning extinction', 'Humanism', 'Trait theory'], optionsKa: ['ფსიქოანალიზზე', 'კლასიკური კონდიციონირების ჩაქრობაზე', 'ჰუმანიზმზე', 'თვისებათა თეორიაზე'], correctIndex: 1, explanation: 'Extinction of fear response.', explanationKa: 'შიშის რეაქციის ჩაქრობა.' },
      { id: 'q15-8', question: 'Lithium treats:', questionKa: 'ლითიუმი მკურნალობს:', options: ['Depression', 'Anxiety', 'Bipolar disorder', 'Schizophrenia'], optionsKa: ['დეპრესიას', 'შფოთვას', 'ბიპოლარულ აშლილობას', 'შიზოფრენიას'], correctIndex: 2, explanation: 'First-line for bipolar disorder.', explanationKa: 'პირველი რიგის მკურნალობა ბიპოლარული აშლილობისთვის.' },
      { id: 'q15-9', question: 'Eclectic approach:', questionKa: 'ეკლექტიკური მიდგომა:', options: ['One method', 'Integrating various techniques', 'Rejecting evidence', 'Only medication'], optionsKa: ['ერთი მეთოდი', 'სხვადასხვა ტექნიკის ინტეგრაცია', 'მტკიცებულებების უარყოფა', 'მხოლოდ მედიკამენტები'], correctIndex: 1, explanation: 'Combining different techniques.', explanationKa: 'სხვადასხვა ტექნიკის კომბინაცია.' },
      { id: 'q15-10', question: 'Therapy works best when:', questionKa: 'თერაპია საუკეთესოდ მუშაობს, როცა:', options: ['One session', 'Strong therapeutic alliance', 'Client passive', 'No diagnosis'], optionsKa: ['ერთი სესია', 'ძლიერი თერაპიული ალიანსი', 'კლიენტი პასიურია', 'დიაგნოზი არ არის'], correctIndex: 1, explanation: 'The relationship is the strongest predictor.', explanationKa: 'ურთიერთობა ყველაზე ძლიერი პრედიქტორია.' }
    ]
  },
  {
    id: 'ch16-quiz', chapterId: 16, title: 'Applied Psychology — Quiz', titleKa: 'გამოყენებითი ფსიქოლოგია — ვიქტორინა',
    questions: [
      { id: 'q16-1', question: 'I/O psychology applies principles to:', questionKa: 'ორგანიზაციული ფსიქოლოგია პრინციპებს იყენებს:', options: ['Hospitals', 'The workplace', 'Animals', 'Children only'], optionsKa: ['საავადმყოფოებში', 'სამუშაო ადგილზე', 'ცხოველებზე', 'მხოლოდ ბავშვებზე'], correctIndex: 1, explanation: 'Industrial-Organizational psychology focuses on the workplace.', explanationKa: 'ორგანიზაციული ფსიქოლოგია ფოკუსირებულია სამუშაო ადგილზე.' },
      { id: 'q16-2', question: 'Growth mindset was proposed by:', questionKa: 'ზრდის აზროვნება შემოთავაზებულია:', options: ['Seligman', 'Csikszentmihalyi', 'Carol Dweck', 'Duckworth'], optionsKa: ['სელიგმანის მიერ', 'ჩიქსენტმიჰაის მიერ', 'კეროლ დუეკის მიერ', 'დაკუორთის მიერ'], correctIndex: 2, explanation: 'Dweck showed believing intelligence is malleable improves performance.', explanationKa: 'დუეკმა აჩვენა, რომ ინტელექტის მოქნილობის რწმენა აუმჯობესებს შესრულებას.' },
      { id: 'q16-3', question: 'Positive psychology focuses on:', questionKa: 'პოზიტიური ფსიქოლოგია ფოკუსირებულია:', options: ['Mental illness', 'Strengths and optimal functioning', 'Diagnosis', 'Medication'], optionsKa: ['ფსიქიკურ დაავადებაზე', 'ძლიერ მხარეებსა და ოპტიმალურ ფუნქციონირებაზე', 'დიაგნოზზე', 'მედიკამენტებზე'], correctIndex: 1, explanation: 'Studying what makes life worth living.', explanationKa: 'რა ხდის ცხოვრებას ღირებულს.' },
      { id: 'q16-4', question: 'Flow state was described by:', questionKa: 'ნაკადის მდგომარეობა აღწერა:', options: ['Seligman', 'Csikszentmihalyi', 'Dweck', 'Duckworth'], optionsKa: ['სელიგმანმა', 'ჩიქსენტმიჰაიმ', 'დუეკმა', 'დაკუორთმა'], correctIndex: 1, explanation: 'Csikszentmihalyi described the state of complete absorption.', explanationKa: 'ჩიქსენტმიჰაიმ აღწერა სრული ჩაძირვის მდგომარეობა.' },
      { id: 'q16-5', question: 'Forensic psychology intersects psychology and:', questionKa: 'სასამართლო ფსიქოლოგია აკავშირებს ფსიქოლოგიას და:', options: ['Education', 'Law', 'Business', 'Medicine'], optionsKa: ['განათლებას', 'სამართალს', 'ბიზნესს', 'მედიცინას'], correctIndex: 1, explanation: 'Forensic psychology applies psychology to legal contexts.', explanationKa: 'სასამართლო ფსიქოლოგია იყენებს ფსიქოლოგიას სამართლებრივ კონტექსტში.' },
      { id: 'q16-6', question: 'Structured interviews are preferred because they:', questionKa: 'სტრუქტურიზებული ინტერვიუები სასურველია, რადგან:', options: ['Are shorter', 'Reduce bias and improve prediction', 'Cost less', 'Are informal'], optionsKa: ['უფრო მოკლეა', 'ამცირებს მიკერძოებას და აუმჯობესებს პროგნოზს', 'ნაკლები ღირს', 'არაფორმალურია'], correctIndex: 1, explanation: 'Structured interviews are more valid and reduce interviewer bias.', explanationKa: 'სტრუქტურიზებული ინტერვიუები უფრო ვალიდურია და ამცირებს მიკერძოებას.' },
      { id: 'q16-7', question: 'Grit research was done by:', questionKa: 'სიჟინჟილის კვლევა ჩაატარა:', options: ['Seligman', 'Csikszentmihalyi', 'Dweck', 'Angela Duckworth'], optionsKa: ['სელიგმანმა', 'ჩიქსენტმიჰაიმ', 'დუეკმა', 'ანჯელა დაკუორთმა'], correctIndex: 3, explanation: 'Duckworth studied perseverance and passion for long-term goals.', explanationKa: 'დაკუორთმა შეისწავლა შეუპოვრობა და ვნება გრძელვადიანი მიზნებისთვის.' },
      { id: 'q16-8', question: 'Collectivistic cultures emphasize:', questionKa: 'კოლექტივისტური კულტურები ხაზს უსვამს:', options: ['Individual achievement', 'Group harmony', 'Competition', 'Personal freedom'], optionsKa: ['ინდივიდუალურ მიღწევას', 'ჯგუფურ ჰარმონიას', 'კონკურენციას', 'პირად თავისუფლებას'], correctIndex: 1, explanation: 'Collectivistic cultures value group goals over individual ones.', explanationKa: 'კოლექტივისტური კულტურები აფასებს ჯგუფურ მიზნებს ინდივიდუალურზე მეტად.' },
      { id: 'q16-9', question: 'The IKEA effect shows people:', questionKa: 'IKEA ეფექტი აჩვენებს, რომ ადამიანები:', options: ['Prefer cheap furniture', 'Value self-built items more', 'Dislike assembly', 'Buy impulsively'], optionsKa: ['ამჯობინებენ იაფ ავეჯს', 'თვითნაშენ ნივთებს მეტად აფასებენ', 'არ მოსწონთ აწყობა', 'იმპულსურად ყიდულობენ'], correctIndex: 1, explanation: 'People overvalue things they helped create.', explanationKa: 'ადამიანები ზედმეტად აფასებენ რამეს, რის შექმნაშიც მონაწილეობდნენ.' },
      { id: 'q16-10', question: 'Health psychology promotes:', questionKa: 'ჯანმრთელობის ფსიქოლოგია ხელს უწყობს:', options: ['Only medication', 'Healthy behaviors and illness prevention', 'Surgery', 'Hospitalization'], optionsKa: ['მხოლოდ მედიკამენტებს', 'ჯანსაღ ქცევებსა და დაავადებების პრევენციას', 'ქირურგიას', 'ჰოსპიტალიზაციას'], correctIndex: 1, explanation: 'Promoting behavior change and preventing illness.', explanationKa: 'ქცევის ცვლილებისა და დაავადებების პრევენციის ხელშეწყობა.' }
    ]
  }
];
